...
export default function Hero() {
  return (
    <section className="pt-32 pb-20 md:pt-48 md:pb-32 px-6 overflow-hidden min-h-screen flex flex-col">
        ...
        >
          <div className="max-w-4xl space-y-4">
            <div className="flex items-center gap-3">
              ...
              <span className="text-[10px] tracking-[0.3em] text-white/40 uppercase">Software Engineer</span>
            </div>
